/*
 * $RCSfile: USB_DA12_8E_Family.cpp,v $
 * $Revision: 1.3 $
 * $Date: 2009/12/23 22:39:10 $
 * jEdit:tabSize=4:indentSize=4:collapseFolds=1:
 *
 * class USB_DA12_8E_Family implementation
 */
...
void USB_DA12_8E_Family::initialize() {
	if( supportedProductIDs.empty() ) {
		supportedProductIDs.insert( supportedProductIDs.end(), USB_DA12_8E );
...
StringArray USB_DA12_8E_Family::getSupportedProductNames() {
	initialize();
	return USBDeviceManager::productIDToName( supportedProductIDs );
}	// USB_DA12_8E_Family::getSupportedProductNames()
...
IntArray USB_DA12_8E_Family::getSupportedProductIDs() {
	initialize();
	return IntArray( supportedProductIDs );
}	// USB_DA12_8E_Family::getSupportedProductIDs()
