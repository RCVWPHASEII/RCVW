/*
 * $RCSfile: USB_CTR_15_Family.java,v $
 ...
 * {@link USBDeviceManager#USB_CTR_15 USB_CTR_15}.<br><br>
 ...
 * to obtain a reference to a <i>USB_CTR_15_Family</i> instance. You can then cast the <i>{@link USBDevice}</i>
 * reference obtained from one of those methods to a <i>USB_CTR_15_Family</i> and make use of this class' methods, like so:
 * <pre>USBDevice[] devices = deviceManager.getDeviceByProductID( USBDeviceManager.USB_CTR_15 );
 *if( devices.length > 0 )
 *  USB_CTR_15_Family device = ( USB_CTR_15_Family ) devices[ 0 ];</pre>
 */

public class USB_CTR_15_Family extends USBDevice {
	...
	protected USB_CTR_15_Family( int productID, int deviceIndex ) {
