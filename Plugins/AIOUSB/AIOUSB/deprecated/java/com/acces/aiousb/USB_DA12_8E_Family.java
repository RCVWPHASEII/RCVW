/*
 * $RCSfile: USB_DA12_8E_Family.java,v $
 ...
 * {@link USBDeviceManager#USB_DA12_8E USB_DA12_8E}.<br><br>
 ...
 * to obtain a reference to a <i>USB_DA12_8E_Family</i> instance. You can then cast the <i>{@link USBDevice}</i>
 * reference obtained from one of those methods to a <i>USB_DA12_8E_Family</i> and make use of this class' methods, like so:
 * <pre>USBDevice[] devices = deviceManager.getDeviceByProductID( USBDeviceManager.USB_DA12_8E );
 *if( devices.length > 0 )
 *  USB_DA12_8E_Family device = ( USB_DA12_8E_Family ) devices[ 0 ];</pre>
 */

public class USB_DA12_8E_Family extends USBDevice {
	...
	protected USB_DA12_8E_Family( int productID, int deviceIndex ) {
