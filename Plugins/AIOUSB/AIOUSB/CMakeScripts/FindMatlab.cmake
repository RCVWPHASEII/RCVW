...
ELSE(WIN32)
  ...
  IF((NOT DEFINED MATLAB_ROOT)
    ...
    EXECUTE_PROCESS(
      ...
      COMMAND xargs readlink -e
      COMMAND xargs dirname
      COMMAND xargs dirname
      COMMAND xargs echo -n
      OUTPUT_VARIABLE MATLAB_ROOT
      ERROR_VARIABLE MATLAB_ERROR_OUTPUT
      )
    STRING( COMPARE NOTEQUAL "${MATLAB_ERROR_OUTPUT}" "" ERROR_FINDING_MATLAB ) 
    IF( ERROR_FINDING_MATLAB ) 
      MESSAGE(FATAL_ERROR "Error unable to find Matlab. Please adjust your PATH to include MATLAB_ROOT/bin" )
    ENDIF( ERROR_FINDING_MATLAB  )
