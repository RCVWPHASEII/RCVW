...
#----------------------------------------------------------------------------
            ...
            CFLAGS="$CFLAGS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -Dchar16_t=UINT16_T" 
...
#           
            ...
            CXXFLAGS="$CXXFLAGS -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE" 
...
#----------------------------------------------------------------------------
            ...
            CFLAGS="$CFLAGS  -fexceptions"
            CFLAGS="$CFLAGS -fPIC -fno-omit-frame-pointer -pthread -Dchar16_t=UINT16_T"
            CLIBS="$RPATH $MLIBS -lm"
            COPTIMFLAGS='-O -DNDEBUG'
            CDEBUGFLAGS='-g'
            CLIBS="$CLIBS -lstdc++"
